...
exports.maybe = maybe;
const mapOptional = (f, list) => (0, list_1.isEmpty)(list) ? (0, exports.makeSome)([]) :
    (0, exports.bind)(f((0, list_1.first)(list)), (fa) => (0, exports.bind)((0, exports.mapOptional)(f, (0, list_1.rest)(list)), (fas) => (0, exports.makeSome)((0, list_1.cons)(fa, fas))));
