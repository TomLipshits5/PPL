...
const isCompoundExp = (x) => (0, exports.isAppExp)(x) || (0, exports.isIfExp)(x) || (0, exports.isProcExp)(x) || (0, exports.isLitExp)(x) || (0, exports.isLetExp)(x);
...
const parseL3Program = (sexp) => sexp === "" || (0, list_1.isEmpty)(sexp) ? (0, result_1.makeFailure)("Unexpected empty program") :
    (0, parser_1.isToken)(sexp) ? (0, result_1.makeFailure)("Program cannot be a single token") :
        (0, type_predicates_1.isArray)(sexp) ? parseL3GoodProgram((0, list_1.first)(sexp), (0, list_1.rest)(sexp)) :
            (0, result_1.makeFailure)("Unexpected type " + sexp);
exports.parseL3Program = parseL3Program;
const parseL3GoodProgram = (keyword, body) => keyword === "L3" && !(0, list_1.isEmpty)(body) ? (0, result_1.mapv)((0, result_1.mapResult)(exports.parseL3Exp, body), (exps) => (0, exports.makeProgram)(exps)) :
    (0, result_1.makeFailure)("Program must be of the form (L3 <exp>+)");
// Exp -> <DefineExp> | <Cexp>
const parseL3Exp = (sexp) => (0, list_1.isEmpty)(sexp) ? (0, result_1.makeFailure)("Exp cannot be an empty list") :
    (0, type_predicates_1.isArray)(sexp) ? (0, exports.parseL3CompoundExp)((0, list_1.first)(sexp), (0, list_1.rest)(sexp)) :
        (0, parser_1.isToken)(sexp) ? (0, exports.parseL3Atomic)(sexp) :
            sexp;
exports.parseL3Exp = parseL3Exp;
// Compound -> DefineExp | CompoundCExp
const parseL3CompoundExp = (op, params) => op === "define" ? (0, exports.parseDefine)(params) :
...
const parseL3CompoundCExp = (op, params) => (0, type_predicates_1.isString)(op) && isSpecialForm(op) ? (0, exports.parseL3SpecialForm)(op, params) :
    parseAppExp(op, params);
exports.parseL3CompoundCExp = parseL3CompoundCExp;
const parseL3SpecialForm = (op, params) => (0, list_1.isEmpty)(params) ? (0, result_1.makeFailure)("Empty args for special form") :
...
const parseGoodDefine = (variable, val) => !(0, type_predicates_1.isIdentifier)(variable) ? (0, result_1.makeFailure)("First arg of define must be an identifier") :
    (0, result_1.mapv)((0, exports.parseL3CExp)(val), (value) => (0, exports.makeDefineExp)((0, exports.makeVarDecl)(variable), value));
const parseL3CExp = (sexp) => (0, list_1.isEmpty)(sexp) ? (0, result_1.makeFailure)("CExp cannot be an empty list") :
    (0, type_predicates_1.isArray)(sexp) ? (0, exports.parseL3CompoundCExp)((0, list_1.first)(sexp), (0, list_1.rest)(sexp)) :
        (0, parser_1.isToken)(sexp) ? (0, exports.parseL3Atomic)(sexp) :
            sexp;
exports.parseL3CExp = parseL3CExp;
// Atomic -> number | boolean | primitiveOp | string
const parseL3Atomic = (token) => token === "#t" ? (0, result_1.makeOk)((0, exports.makeBoolExp)(true)) :
...
const parseProcExp = (vars, body) => (0, type_predicates_1.isArray)(vars) && (0, list_1.allT)(type_predicates_1.isString, vars) ? (0, result_1.mapv)((0, result_1.mapResult)(exports.parseL3CExp, body), (cexps) => (0, exports.makeProcExp)((0, ramda_1.map)(exports.makeVarDecl, vars), cexps)) :
...
const unparseL3 = (exp) => (0, exports.isBoolExp)(exp) ? (0, L3_value_1.valueToString)(exp.val) :
            ...
            (0, exports.isLitExp)(exp) ? unparseLitExp(exp) :
                (0, exports.isVarRef)(exp) ? exp.var :
                    (0, exports.isProcExp)(exp) ? unparseProcExp(exp) :
                        (0, exports.isIfExp)(exp) ? `(if ${(0, exports.unparseL3)(exp.test)} ${(0, exports.unparseL3)(exp.then)} ${(0, exports.unparseL3)(exp.alt)})` :
                            (0, exports.isAppExp)(exp) ? `(${(0, exports.unparseL3)(exp.rator)} ${unparseLExps(exp.rands)})` :
                                (0, exports.isPrimOp)(exp) ? exp.op :
                                    (0, exports.isLetExp)(exp) ? unparseLetExp(exp) :
                                        (0, exports.isDefineExp)(exp) ? `(define ${exp.var.var} ${(0, exports.unparseL3)(exp.val)})` :
                                            (0, exports.isProgram)(exp) ? `(L3 ${unparseLExps(exp.exps)})` :
                                                exp;
